                ...
                <div class="dropdown-menu">
                    <div class="p-3">
                        ...
                        <div class="mt-3">
                            ...
                            <button class="btn btn-sm btn-primary ms-3" id="ordenarClientes" style="width:90px;">Aplicar</button>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="row mt-3">
            <div class="col-9 overflow-auto" style="height:550px ;">
                <div class="row">
                    <div class="col-11">
                        <h3>Todos</h3>
                        <div class="row" id="cont-cli-cards">
